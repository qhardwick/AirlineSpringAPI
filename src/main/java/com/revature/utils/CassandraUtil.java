...
public class CassandraUtil {
	...
	CqlSessionFactoryBean session() {
		...
		cqlSessionFactory.setSessionBuilderConfigurer(sessionBuilder -> sessionBuilder.withConfigLoader(loader).withKeyspace("airline"));
		cqlSessionFactory.setKeyspaceName("airline");
